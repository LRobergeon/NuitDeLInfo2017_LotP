...
function Game() {
  ...
  this.startButton.addEventListener('click', function(){this.scoreFaux = 0});
}
...
Game.prototype.clickOnCell = function(event) {
  this.scoreFaux = this.scoreFaux + 1;
  console.log(document.getElementById("scoreFaux"));
  document.getElementById("scoreFaux").innerHTML = this.scoreFaux;
  console.log(this.scoreFaux);
